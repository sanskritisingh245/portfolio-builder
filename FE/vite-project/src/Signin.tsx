export const SignIn = () =>{
    return(
        <div className="flex h-screen items-center justify-center bg-[radial-gradient(circle_at_50%_100%,#f472b6_0%,#a78bfa_30%,#312e81_65%,#020617_100%)] ">
            <div className="flex  rounded-2xl flex-col items-center content-center justify-center border bg-neutral-900 py-16 px-24 shadow-2xl gap-6 ">
                <p className="text-4xl  font-bold font-sans text-white">SignIn</p>
